(() => {
    ...
    const timeForPersonDefaultSec = 5;
    const timeForPersonDefaultMsec = 6e4 * timeForPersonDefaultSec;
    ...
    function showTimer(e) {
        ...
        let secsForm;
        let timerMessage;
        if (localStorage.getItem(activeUser) && localStorage.getItem(activeUser) > 0) timeToEnd = localStorage.getItem(activeUser); else timeToEnd = timeForPersonDefaultMsec;
    ...
    document.getElementById("settings-icon").addEventListener("click", (function() {
        if ("display:flex" === document.getElementById("popup").getAttribute("style")) document.getElementById("popup").setAttribute("style", "display:none"); else document.getElementById("popup").setAttribute("style", "display:flex");
    }));
    window["FLS"] = true;
    isWebp();
})();